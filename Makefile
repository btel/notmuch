...
INCFLAGS = -I. -I-I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir) -I/usr/local/Cellar/ruby/2.2.0/include/ruby-2.2.0/x86_64-darwin14/
DEFS     = 
...
extout_prefix = 
target_prefix = 
LOCAL_LIBS = /usr/local/Cellar/notmuch/0.18.1/lib/libnotmuch.dylib
